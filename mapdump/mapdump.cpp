...
int main(const int argc, const char **argv)
{
    ...
    if (args.HasFlag("--dump-visual-model"))
    {
        ...
        printf("Exporting Visual Model to \"%s\"...\n", modelPath.c_str());
    ...
    if (args.HasFlag("--dump-lightmap-model"))
    {
        ...
        printf("Exporting Lightmap Model to \"%s\"...\n", modelPath.c_str());
    ...
    if (args.HasFlag("--dump-collision-model"))
    {
        ...
        printf("Exporting Collision Model to \"%s\"...\n", modelPath.c_str());
    ...
    if (args.HasFlag("--dump-lightmap"))
    {
        ...
        printf("Exporting Lightmap to \"%s\"...\n", lightmapPath.c_str());
