...
int main(const int argc, const char **argv)
{
    ...
    if (argc != 2)
    {
        printf("usage: mapdump [gmap file]\n");
        return 0;
    }
    ...
    Asset asset;
    const Error::ErrorCode e = AssetReader::LoadFromFile(argv[1], asset);
    ...
    printf("Exporting visual.obj...\n");
    {
        std::ofstream visualMesh = std::ofstream("visual.obj");
        if (!visualMesh.is_open())
        {
            printf("Failed to open visual.obj\n");
            return 1;
        }
    ...
    printf("Exporting visual_lightmap.obj...\n");
    {
        std::ofstream visualLightmapMesh = std::ofstream("visual_lightmap.obj");
        if (!visualLightmapMesh.is_open())
        {
            printf("Failed to open visual_lightmap.obj\n");
            return 1;
        }
    ...
    printf("Exporting collision.obj...\n");
    {
        std::ofstream collisionMesh = std::ofstream("collision.obj");
        if (!collisionMesh.is_open())
        {
            printf("Failed to open collision.obj\n");
            return 1;
        }
    ...
    printf("Exporting lightmap.exr...\n");
    {
        ...
        OutputFile file("lightmap.exr", header);
