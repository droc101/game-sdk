...
class DialogFilters
{
    public:
        ...
        // shdedit
        static constexpr std::array<SDL_DialogFileFilter, 4> glslFilters = {
        ...
        static constexpr std::array<SDL_DialogFileFilter, 1> wavFilters = {
                SDL_DialogFileFilter{"WAV audio", "wav"}
        };
        ...
        static constexpr std::array<SDL_DialogFileFilter, 1> pngFilters = {
