...
static std::vector<ShaderAsset::ShaderType> types{};
...
int main(const int argc, const char** argv)
{
    ...
    if (args.HasFlag("--help") || args.HasFlag("-h"))
    {
        ...
        printf("--output-directory=/path/to/output/folder/....................The path to the folder where compiled GSHD files should be written.\n");
        printf("--source-file=/path/to/glsl/source/file.......................The path to the GLSL source file to compile.\n");
        printf("--source-directory=/path/to/glsl/sources/folder...............The path to a folder containing GLSL files to compile.\n");
        printf("--base-directory=/path/to/glsl/sources/folder.................Replicates the folder structure starting at this path.\n");
        printf("-O, --optimize................................................Enable optimization.\n");
        printf("-g, --debug-info..............................................Enable debug info.\n");
        printf("-r, --replicate-source-directory..............................Replicates the folder structure of the path specified in --source-directory.\n");
        printf("-d, --dump-spirv..............................................Dump raw SPIR-V binaries alongside the compiled shaders.\n");
        return 0;
    }
