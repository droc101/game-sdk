...
int main()
{
    ...
    constexpr SDL_WindowFlags window_flags = SDL_WINDOW_HIDDEN | SDL_WINDOW_HIGH_PIXEL_DENSITY | SDL_WINDOW_RESIZABLE;
    SDL_Window *window = SDL_CreateWindow("Game SDK",
                                          static_cast<int>(350 * main_scale),
                                          static_cast<int>(250 * main_scale),
                                          window_flags);
    if (window == nullptr)
    {
